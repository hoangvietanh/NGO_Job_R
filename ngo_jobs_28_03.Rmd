---
title: "Job Report for NGO Recruitment" 
...
Khi phân tích thông tin tuyển dụng trong 8 năm qua ở trang Web này, chúng tôi thấy một số xu hướng như sau:
...
- Làm sạch và lưu thành các thuộc tính quan trọng (jobs name, donors, date, location) - Thực hiện một số tính toán đơn giản như số đếm job theo năm, số job theo nhà tài trợ, đếm từ khóa để thống kê ngành nghề 
...
library(stringr)
library(highcharter)
job <- read.csv("C:/Users/Viet Anh/Documents/ngo_jobs/NGO-Jobs-v4.csv")
...
set.seed(1)
wordcloud2(d %>% filter(freq >= 50, word != d$word[7]), 
           color = "random-light", 
